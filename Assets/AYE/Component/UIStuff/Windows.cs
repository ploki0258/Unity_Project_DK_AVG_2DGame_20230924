...
public abstract class Windows<T> : SingletonMonoBehaviour<T> where T : class
{
    ...
    [SerializeField] Volume volumeSupport = null;
    ...
    void GetCanvasGroup()
    {
        ...
        {
            volumeSupport = this.gameObject.GetComponent<Volume>();
        }
    }
    ...
    virtual protected void Update()
    {
        ...
        if (volumeSupport != null)
        {
            if (volumeSupport.weight != canvasGroup.alpha)
            volumeSupport.weight = canvasGroup.alpha;
        }
    }
