...
public class GoodUIBar : MonoBehaviour
{
    ...
    [SerializeField] [Header("增益條(介於主UI條與延遲條之間)")] Image addBar = null;
    ...
    void ShockUpdate()
    {
        ...
        shockRoot.anchoredPosition = new Vector2((-0.5f * shockRange) + (Mathf.PerlinNoise(t, 0f) * shockRange), Random.Range(-1f, 1f));
