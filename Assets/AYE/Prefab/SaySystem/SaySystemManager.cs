...
public class SaySystemManager : SimpleSingleton<SaySystemManager>
{
    ...
    public override void OnSingletonLoad()
    {
        base.OnSingletonLoad();

        TextAsset mainData = Resources.Load<TextAsset>("SaySystemData/MainData");
        SetTextAsset(mainData);
    }

    public void SetTextAsset(TextAsset mainData)
    {
